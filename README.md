# JustText
I don't get why it's so hard to just chat with people without having to log in or getting your information stolen. That's why i made a little chat app with turbowarp.
JustText is a chat app that you can use in your browser, without any login and without getting your pesonal information stolen! (isn't that great!)

# Making a private room
I did include a public server in this repo, but you probaly want a private chat.<br>
__NEW METHOD:__<br>
go to [this website](https://dutchducksdevelopment.github.io/cloud-id-renamer?txt=TextNumbersAndSymbols123&title=JustText) and upload the JustText.html file. Then, enter your own unique id, press enter and the downloaded file should work!<br>
__OLD METHOD:__<br>
